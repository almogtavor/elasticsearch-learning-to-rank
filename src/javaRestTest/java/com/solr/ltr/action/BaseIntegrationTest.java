...
import com.solr.ltr.LtrQueryParserPlugin;
import com.solr.ltr.feature.FeatureValidation;
...
import static com.solr.ltr.feature.store.ScriptFeature.EXTRA_LOGGING;
import static com.solr.ltr.feature.store.ScriptFeature.FEATURE_VECTOR;
...
public abstract class BaseIntegrationTest extends ESSingleNodeTestCase {
    ...
    public FeatureStoreAction.FeatureStoreResponse addElement(StorableElement element,
    ...
    public FeatureStoreAction.FeatureStoreResponse addElement(StorableElement element, String store) throws ExecutionException, InterruptedException {
        return addElement(element, null, store);
    }

    public FeatureStoreAction.FeatureStoreResponse addElement(StorableElement element) throws ExecutionException, InterruptedException {
    ...
    public FeatureStoreAction.FeatureStoreResponse addElement(StorableElement element,
        ...
        FeatureStoreAction.FeatureStoreResponse response = builder.execute().get();
