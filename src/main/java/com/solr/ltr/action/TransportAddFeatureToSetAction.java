...
import com.solr.ltr.action.FeatureStoreAction.FeatureStoreRequest;
...
public class TransportAddFeatureToSetAction extends HandledTransportAction<AddFeaturesToSetAction.AddFeaturesToSetRequest, AddFeaturesToSetAction.AddFeaturesToSetResponse> {
    ...
    public TransportAddFeatureToSetAction(Settings settings, ThreadPool threadPool,
        ...
        super(AddFeaturesToSetAction.NAME, transportService, actionFilters, AddFeaturesToSetAction.AddFeaturesToSetRequest::new);
    ...
    private static class AsyncAction {
        ...
        AsyncAction(Task task, AddFeaturesToSetAction.AddFeaturesToSetRequest request, ActionListener<AddFeaturesToSetAction.AddFeaturesToSetResponse> listener,
        ...
        private void updateSet(StoredFeatureSet set) {
            ...
            featureStoreAction.execute(frequest, wrap(
                    (r) -> listener.onResponse(new AddFeaturesToSetAction.AddFeaturesToSetResponse(r.getResponse())),
                    listener::onFailure));
        }
    }
