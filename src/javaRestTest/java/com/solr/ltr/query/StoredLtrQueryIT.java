...
import com.solr.ltr.action.BaseIntegrationTest;
import com.solr.ltr.action.CachesStatsAction;
import com.solr.ltr.action.ClearCachesAction;
import com.solr.ltr.action.CreateModelFromSetAction.CreateModelFromSetRequestBuilder;
import com.solr.ltr.feature.store.ScriptFeature;
...
public class StoredLtrQueryIT extends BaseIntegrationTest {
    ...
    public void testFullUsecase() throws Exception {
        ...
        CachesStatsAction.CachesStatsNodesResponse stats = client().execute(CachesStatsAction.INSTANCE,
