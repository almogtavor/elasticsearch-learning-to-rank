...
public class TermStatQuery extends Query {
    ...
    public StatisticsHelper.AggrType getAggr() { return this.aggr; }
    public StatisticsHelper.AggrType getPosAggr() { return this.posAggr; }
    ...
    static class TermStatWeight extends Weight {
        ...
        TermStatWeight(IndexSearcher searcher,
                       ...
                       Set<Term> terms,
                       ScoreMode scoreMode,
                       StatisticsHelper.AggrType aggr,
                       StatisticsHelper.AggrType posAggr) throws IOException {
            super(tsq);
