...
import static com.solr.ltr.LtrTestUtils.randomFeature;
...
public class AddFeaturesToSetActionIT extends BaseIntegrationTest {
    public void testAddToSetWithQuery() throws Exception {
        ...
        AddFeaturesToSetAction.AddFeaturesToSetRequestBuilder builder = new AddFeaturesToSetAction.AddFeaturesToSetRequestBuilder(client());
        ...
        AddFeaturesToSetAction.AddFeaturesToSetResponse resp = builder.execute().get();
        ...
        builder = new AddFeaturesToSetAction.AddFeaturesToSetRequestBuilder(client());
        builder.request().setFeatureSet("new_feature_set");
    ...
    public void testFailuresOnDuplicates() throws Exception {
        ...
        AddFeaturesToSetAction.AddFeaturesToSetRequestBuilder builder2= new AddFeaturesToSetAction.AddFeaturesToSetRequestBuilder(client());
