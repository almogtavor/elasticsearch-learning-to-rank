...
package com.solr.ltr.query;

import com.solr.ltr.LtrQueryContext;
import com.solr.ltr.feature.*;
import com.solr.ltr.ranker.LogLtrRanker;
import com.solr.ltr.ranker.LtrRanker;
import com.solr.ltr.ranker.NullRanker;
...
public class RankerQuery extends Query {
     ...
     * Prebuilt models are not parametrized as they contain only {@link PrebuiltFeature}
     *
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
        ...
        Suppliers.MutableSupplier<LtrRanker.FeatureVector> vectorSupplier = new Suppliers.FeatureVectorSupplier();
...
//            }
    ...
    static class FVLtrRankerWrapper implements LtrRanker {
        ...
        private final Suppliers.MutableSupplier<FeatureVector> vectorSupplier;

        FVLtrRankerWrapper(LtrRanker wrapped, Suppliers.MutableSupplier<FeatureVector> vectorSupplier) {
