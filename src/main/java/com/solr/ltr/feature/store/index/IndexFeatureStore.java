...
package com.solr.ltr.feature.store.index;
...
import com.solr.ltr.feature.store.FeatureStore;
...
public class IndexFeatureStore implements FeatureStore {
    ...
    public <E extends StorableElement> E getAndParse(String name, Class<E> eltClass, String type) throws IOException {
        GetResponse response = internalGet(StorableElement.generateId(type, name)).get();
    ...
    public GetResponse getFeature(String name) {
        return internalGet(StorableElement.generateId(StoredFeature.TYPE, name)).get();
    }

    public GetResponse getFeatureSet(String name) {
        return internalGet(StorableElement.generateId(StoredFeatureSet.TYPE, name)).get();
    }

    public GetResponse getModel(String name) {
        return internalGet(StorableElement.generateId(StoredLtrModel.TYPE, name)).get();
    }
