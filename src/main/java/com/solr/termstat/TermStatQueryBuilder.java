package com.solr.termstat;

import com.solr.ltr.utils.Scripting;
import com.solr.explore.StatisticsHelper;
...
public class TermStatQueryBuilder extends AbstractQueryBuilder<TermStatQueryBuilder> implements NamedWriteable {
    ...
    protected Query doToQuery(SearchExecutionContext context) throws IOException {
        ...
        StatisticsHelper.AggrType aggrType = StatisticsHelper.AggrType.valueOf(aggr.toUpperCase(Locale.getDefault()));
        StatisticsHelper.AggrType posAggrType = StatisticsHelper.AggrType.valueOf(pos_aggr.toUpperCase(Locale.getDefault()));
