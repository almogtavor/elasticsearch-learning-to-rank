...
import static com.solr.ltr.query.ValidatingLtrQueryBuilder.SUPPORTED_TYPES;
...
public class RestFeatureManager extends FeatureStoreBaseRestHandler {
    ...
    RestChannelConsumer delete(NodeClient client, String type, String indexName, RestRequest request) {
        ...
        return (channel) ->  {
            ...
            client.prepareDelete(indexName, IndexFeatureStore.ES_TYPE, id)
                    .setRouting(routing)
    ...
    RestChannelConsumer get(NodeClient client, String type, String indexName, RestRequest request) {
        ...
        String routing = request.param("routing");
        String id = StorableElement.generateId(type, name);
        return (channel) -> client.prepareGet(indexName, IndexFeatureStore.ES_TYPE, id)
                .setRouting(routing)
